...
namespace MetaMask.Unity.Samples
{
    ...
    public class MetaMaskDemo : MonoBehaviour
    {
        ...
        public GameObject endScreen, metaScreen, player, successTransaction;
        ...
        public async void SendTransaction()
        {
            ...
            Debug.Log(">>>>>>>>>>>>>-------------------------- Usepsna transakcija! 69696969 SAAAAAAAAAAAMO JEDNOOOOOOOOOM"); //OVDE ZVANICNO TREBA DA UBACIM KOD DA NASTAVIM IGRU :D
            endScreen.SetActive(false);
            metaScreen.SetActive(false);
            player.SetActive(true);
            player.GetComponent<Player>().BecomeInvulnerable();
            successTransaction.SetActive(true);
        }
